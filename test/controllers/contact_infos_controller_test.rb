...
class ContactInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_info" do
    assert_difference("ContactInfo.count") do
      post contact_infos_url, params: { contact_info: { contact_id: @contact_info.contact_id, number: @contact_info.number, type: @contact_info.type } }
    end
  ...
  test "should update contact_info" do
    patch contact_info_url(@contact_info), params: { contact_info: { contact_id: @contact_info.contact_id, number: @contact_info.number, type: @contact_info.type } }
